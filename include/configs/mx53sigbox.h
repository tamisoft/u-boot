 ...
 * Levente Tamas <levente.tamas@navicron.com>
 *
...
#define MACH_TYPE_MX53_SIGBOX 3274
#define CONFIG_MACH_TYPE	MACH_TYPE_MX53_SIGBOX
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmcboot_old=echo Booting from mmc ...; " \
		...
		"else " \
			"bootz; " \
		"fi;\0" \
	"netargs=setenv bootargs console=ttymxc1,${baudrate} " \
		"root=/dev/nfs " \
